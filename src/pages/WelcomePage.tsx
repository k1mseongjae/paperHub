        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-10 mt-12">
            <div className="p-8 bg-white rounded-xl shadow-md text-center">
              <h4 className="text-xl font-semibold">Smart Organization</h4>
              <p className="mt-2 text-gray-600">Automatically categorize your papers with AI-powered tagging and clustering.</p>
            </div>
            <div className="p-8 bg-white rounded-xl shadow-md text-center">
              <h4 className="text-xl font-semibold">Interactive Reading</h4>
              <p className="mt-2 text-gray-600">Highlight, take notes, and link ideas directly on your PDFs.</p>
            </div>
            <div className="p-8 bg-white rounded-xl shadow-md text-center">
              <h4 className="text-xl font-semibold">Knowledge Graph</h4>
              <p className="mt-2 text-gray-600">Visualize connections between papers and topics in an Obsidian-like graph view.</p>
            </div>
          </div>
        </div>
      </section>
